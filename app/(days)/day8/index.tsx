...
import TouchableRipple from '@/components/CustomTouchableRipple/CustomTouchableRipple'; // Make sure to import the new component
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <TouchableRipple
        ...
        style={{ padding: 50, borderRadius: 40 , backgroundColor: '#E2E8F0' , width: "80%" , alignItems: "center"}}
      >
        <Text>Press Me</Text>
      </TouchableRipple>
        {/* <CustomOtpInput
